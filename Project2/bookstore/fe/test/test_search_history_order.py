...
class TestSearchHistoryOrder:
    ...
    def pre_run_initialization(self):
        self.buyer_id = "test_search_history_order_buyer_id_{}".format(time.time())
    ...
    def test_ok(self):
        for _ in range(3):
            self.seller_id = "test_search_history_order_seller_id_{}".format(time.time())
            self.store_id = "test_search_history_order_store_id_{}".format(time.time())
